...
export class HelloLambdaStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const api = new apigateway.RestApi(this, 'my-api', {
      ...
      description: "This service serves the Lambda functions."
    });
    ...
    // On this resource attach a GET method which pass request to the lambda function
    helloResource.addMethod('GET', helloFromLambdaIntegration, {
      methodResponses: [{ statusCode: '200' }],
    });

    /* Example in case you want to add more methods or resources 
        const helloUserResource = helloResource.addResource('{user_id}')
        helloUserResource.addMethod('GET', ...);
    */
  }
}